...
run_right_list = [pygame.image.load("core_character_run_right_1.png"), pygame.image.load("core_character_run_right_2.png"), pygame.image.load("core_character_run_right_3.png"), pygame.image.load("core_character_run_right_4.png"), pygame.image.load("core_character_run_right_5.png"), pygame.image.load("core_character_run_right_6.png")]
